 ...
 * @author Yunisel
 */
public class MyOwnLabel extends JLabel implements IControl{
    ...
    public MyOwnLabel(String name, int indexInContainer, String text, final MainView mainScreen, ControlType controlType) {
        super();
        setText(text);
