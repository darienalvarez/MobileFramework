 ...
 * @author Yunisel
 */
public class MyOwnCheckBox extends JCheckBox implements IControl{
    ...
    public MyOwnCheckBox(String name, int indexInContainer, String text, final MainView mainScreen, ControlType controlType) {
        super();
        setText(text);
        ...
        try {
          control = new ControlWebServiceImpl(new URI(mainScreen.GAZOO_DIR + "ControlService?wsdl").toURL()).getControlWebServiceImplPort();
                ...
                Logger.getLogger(MyOwnCheckBox.class.getName()).log(Level.SEVERE, null, ex);
        }
