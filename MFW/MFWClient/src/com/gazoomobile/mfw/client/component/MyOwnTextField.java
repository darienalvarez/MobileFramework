 ...
 * @author Yunisel
 */
public class MyOwnTextField extends JTextField implements IControl{
    ...
    public MyOwnTextField(String name, int indexInContainer, final MainView mainScreen, ControlType controlType) {
        super();
       ...
       // ControlType ct = new ControlType();
        ...
        try {
          control = new ControlWebServiceImpl( new URI(mainScreen.GAZOO_DIR + "ControlService?wsdl").toURL()).getControlWebServiceImplPort();
                ...
                Logger.getLogger(MyOwnTextField.class.getName()).log(Level.SEVERE, null, ex);
        }
