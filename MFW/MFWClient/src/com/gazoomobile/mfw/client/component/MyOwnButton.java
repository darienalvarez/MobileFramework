 ...
 * @author Yunisel
 */
public class MyOwnButton extends JButton implements IControl {
    ...
    public MyOwnButton(String name,  int indexInContainer, String text, final MainView mainScreen, ControlType controlType) {
        super();
        setText(text);
