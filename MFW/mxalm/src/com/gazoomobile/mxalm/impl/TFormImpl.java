 ...
 */
public class TFormImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.gazoomobile.mxalm.TForm
{
    private static final long serialVersionUID = 1L;
    
    public TFormImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName VERTICALLAYOUT$16 = 
        new javax.xml.namespace.QName("http://www.gazoomobile.com/mxalm", "verticallayout");
    private static final javax.xml.namespace.QName HORIZONTALLAYOUT$18 = 
    ...
    public com.gazoomobile.mxalm.TVerticallayout getVerticallayout()
    {
        synchronized (monitor())
        {
            ...
            target = (com.gazoomobile.mxalm.TVerticallayout)get_store().find_element_user(VERTICALLAYOUT$16, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(verticallayout, VERTICALLAYOUT$16, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.gazoomobile.mxalm.TVerticallayout addNewVerticallayout()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.gazoomobile.mxalm.TVerticallayout target = null;
            target = (com.gazoomobile.mxalm.TVerticallayout)get_store().add_element_user(VERTICALLAYOUT$16);
            return target;
        }
    }
    ...
    public com.gazoomobile.mxalm.THorizontallayout getHorizontallayout()
    {
        synchronized (monitor())
        {
            ...
            target = (com.gazoomobile.mxalm.THorizontallayout)get_store().find_element_user(HORIZONTALLAYOUT$18, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(horizontallayout, HORIZONTALLAYOUT$18, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.gazoomobile.mxalm.THorizontallayout addNewHorizontallayout()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.gazoomobile.mxalm.THorizontallayout target = null;
            target = (com.gazoomobile.mxalm.THorizontallayout)get_store().add_element_user(HORIZONTALLAYOUT$18);
            return target;
        }
    }
    ...
    public com.gazoomobile.mxalm.TTable getTable()
    {
        synchronized (monitor())
        {
            ...
            target = (com.gazoomobile.mxalm.TTable)get_store().find_element_user(TABLE$20, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(table, TABLE$20, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.gazoomobile.mxalm.TTable addNewTable()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.gazoomobile.mxalm.TTable target = null;
            target = (com.gazoomobile.mxalm.TTable)get_store().add_element_user(TABLE$20);
            return target;
        }
    }
    ...
    public org.apache.xmlbeans.XmlString xgetAction()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(ACTION$24);
            return target;
        }
    }
    ...
    public void xsetAction(org.apache.xmlbeans.XmlString action)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(ACTION$24);
            }
            target.set(action);
        }
    }
