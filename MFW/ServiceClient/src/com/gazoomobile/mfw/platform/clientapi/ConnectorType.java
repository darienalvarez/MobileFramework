 ...
 *         &lt;element name="connectorProperties" type="{http://impl.web.platform.mfw.gazoomobile.com/}connectorProperty" maxOccurs="unbounded" minOccurs="0"/>
...
public class ConnectorType {
    ...
    protected List<ConnectorProperty> connectorProperties;
     ...
     * This is why there is not a <CODE>set</CODE> method for the connectorProperties property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getConnectorProperties().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<ConnectorProperty> getConnectorProperties() {
        if (connectorProperties == null) {
            connectorProperties = new ArrayList<ConnectorProperty>();
        }
