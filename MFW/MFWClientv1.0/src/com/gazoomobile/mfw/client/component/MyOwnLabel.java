 ...
 * @author Yunisel
 */
public class MyOwnLabel extends JLabel implements IControl, IDataSourceComponent{
    ...
    private Long globalID;
     ...
     static {
         try {
             ...
             Logger logger = Logger.getLogger(MyOwnLabel.class.getName());
    ...
    public MyOwnLabel(String name, int indexInContainer, final MainView mainScreen, ControlType controlType) {
        super();
        setText("label");
...
//        ControlWebService control = null;
//        try {
//          control = new ControlWebServiceImpl(new URI(MainView.GAZOO_DIR + "ControlService?wsdl").toURL()).getControlWebServiceImplPort();
//        } catch (Exception ex) {
//                Logger.getLogger(MyOwnLabel.class.getName()).log(Level.SEVERE, null, ex);
//        }
//        properties = control.getPropertiesByControlType(MainView.controlType.getType());
        ...
        modifyPropertieValue("stringvalue", "label");
