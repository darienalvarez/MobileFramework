 ...
 * @author Yunisel
 */
public class MyOwnTextBox extends JTextArea implements IControl, IDataSourceComponent{
    ...
    private Long globalID;
     ...
     static {
         try {
             ...
             Logger logger = Logger.getLogger(MyOwnTextBox.class.getName());
    ...
    public MyOwnTextBox(String name, int indexInContainer, final MainView mainScreen, ControlType controlType) {
        super();
