...
public class MyOwnListBox extends JList implements IControl, IOptionControl, IDataSourceComponent {
    ...
    private Long globalID;
     ...
     static {
         try {
             ...
             Logger logger = Logger.getLogger(MyOwnListBox.class.getName());
    ...
    public MyOwnListBox(String name, int indexInContainer, final MainView mainScreen, ControlType controlType) {
        super();
...
//        } catch (Exception ex) {
//            Logger.getLogger(MyOwnListBox.class.getName()).log(Level.SEVERE, null, ex);
//        }
...
//        properties = control.getPropertiesByControlType(controlType.getType());
    ...
    private void resetModel(final String[] strings) {
        //TODO: Limpiar valores mostrados
...
//         values.set(1,data);
        Option op = new Option(mainScreen, id, value, true);
        options.add(op);
