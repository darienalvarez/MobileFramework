...
@XmlRootElement(name = "removeUser", namespace = "http://impl.web.platform.mfw.gazoomobile.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "removeUser", namespace = "http://impl.web.platform.mfw.gazoomobile.com/")
