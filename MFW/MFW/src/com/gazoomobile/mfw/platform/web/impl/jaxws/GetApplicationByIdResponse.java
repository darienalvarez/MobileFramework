...
@XmlRootElement(name = "getApplicationByIdResponse", namespace = "http://impl.web.platform.mfw.gazoomobile.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getApplicationByIdResponse", namespace = "http://impl.web.platform.mfw.gazoomobile.com/")
